package io.devonfw.module.starters.devon4j.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see io.devonfw.module.starters.devon4j.general.common.api.exception.NoActiveUserException
   *

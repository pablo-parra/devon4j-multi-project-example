package io.devonfw.application.authors.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the authors application.
 */
